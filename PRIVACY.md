...
HumanToday is a skills-only plugin. It does not run an external server, require an account, or collect, store, or sell personal data.
...
Questions and issues: https://github.com/aiwithenoch/humantoday/issues
